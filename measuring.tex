...
\includegraphics[width=0.45\textwidth]{figures/avg_down_file_transfer_speed_new.eps}}
  \subfigure[Upload file MTS distributions.]
{\label{fig:avg_up_file_transfer_speed}
\includegraphics[width=0.45\textwidth]{figures/avg_up_file_transfer_speed_new.eps}}      
  \subfigure[Download bandwidth distributions.]
{\label{fig:down_bw_comparison}
\includegraphics[width=0.45\textwidth]{figures/down_bw_comparison_new.eps}}
  \subfigure[Upload bandwidth distributions.]
{\label{fig:up_bw_comparison}
\includegraphics[width=0.45\textwidth]{figures/up_bw_comparison_new.eps}}
...
\begin{figure*}
\centering	
  \subfloat[DropBox down. file MTS fitting ($150$MB files).]
{\label{fig:qq_plot_dropbox_dmts}
\includegraphics[width=0.325\textwidth]{dropbox_dw_150mb_fittings.eps}} 
 	\subfloat[DropBox up. file MTS fitting ($150$MB files).]
{\label{fig:qq_plot_dropbox_umts}
\includegraphics[width=0.325\textwidth]{dropbox_up_150mb_fittings.eps}}
 	\subfloat[Box down. file MTS fitting ($100$MB files).]
{\label{fig:qq_plot_box_dmts}

\includegraphics[width=0.325\textwidth]{box_dw_100mb_fittings.eps}}
	\caption{Distribution fittings of upload/download file mean transfer speeds 
	(MTS) of the examined Personal Clouds (up/down workload, university labs).}
	\label{fig:qq_plot}
	\vspace{-4mm}
\end{figure*}
...
Personal Cloud datacenters are located in USA~\cite{inside_dropbox}, 
...
\begin{figure}
\centering	
  %\subfloat[Download MTS distribution.]
{\label{fig:transfer_times_geographic_location_downloads}
\includegraphics[width=0.31\textwidth]{geographic_location_downloads.eps}} \\
 	%\subfloat[Upload MTS distribution.]
{\label{fig:transfer_times_geographic_location_uploads}
\includegraphics[width=0.31\textwidth]{geographic_location_uploads.eps}}
%\subfloat[-.]
...
An interesting fact appreciable in Table \ref{tab:service_variability_file_size}
...
\begin{figure}
\centering	
  %\subfloat[Download transfer times CDF.]
{\label{fig:down_transfer_times_by_size}
\includegraphics[width=0.31\textwidth]{download_times_by_file_size.eps}} \\

 	%\subfloat[Upload transfer times CDF.]
{\label{fig:up_transfer_times_by_size}
\includegraphics[width=0.31\textwidth]{upload_times_by_file_size.eps}}
%\subfloat[-.]
%{\label{fig:mean_upload_speed_distributions_by_file_size}
%\includegraphics[width=0.24\textwidth]{mean_upload_speed_distributions_by_file_size.eps}}
%  \subfloat[-.]
...
\begin{figure*}
  ...
  \subfloat[SugarSync does not present important changes
  in both in/out traffic speed over time.]
{\label{fig:transfer_time_series_variability_sugarsync}
\includegraphics[width=0.315\textwidth]{sugarsync_time_series.eps}}
  \subfloat[We observe daily patterns in the DropBox upload transfer speed.
  Download transfer speed remains stable.]
{\label{fig:transfer_time_series_variability_dropbox}
\includegraphics[width=0.34\textwidth]{dropbox_time_series.eps}}  
  \subfloat[Box upload transfers are highly variable and probably affected by
  daily patterns.]
{\label{fig:transfer_time_series_variability_box}

\includegraphics[width=0.32\textwidth]{box_time_series.eps}}         
...
\begin{figure}	  
\includegraphics[width=0.22\textwidth]{transfer_speed_vs_storage_load_dropbox.eps}
\includegraphics[width=0.22\textwidth]{transfer_speed_vs_storage_load_box.eps}
	\vspace{-2mm}

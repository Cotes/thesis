...
\begin{itemize}
	...
	been extensively tested using generated traces to analyze the efficient use of resources.	
\end{itemize}
...
We conclude this thesis in Chapter 6, where we draw some conclusions and enumerate the achieved goals through our study. Finally, we propose future work which can be performed on the topic of this Master Thesis.

...
\begin{figure*}[t]
  \centering
  \subfigure[File size vs file count distribution.]{
    \label{fig:validation:cdf_files}
    \includegraphics[width=0.3\textwidth]{figures/cdf_files}
  }
  \subfigure[Boxplots of synchronization time]{
    \label{fig:validation:a}
    \includegraphics[width=0.3\textwidth]{figures/fig10_2}
  }
  \subfigure[Synchronization time against file size]{
    \label{fig:validation:b}
    \includegraphics[width=0.3\textwidth]{figures/fig11}
  }
  \subfigure[Overhead]{
    \label{fig:validation:overhead_clients}
    \includegraphics[width=0.3\textwidth]{figures/overhead_clients}
  }
  \subfigure[Control traffic overhead]{
    \label{fig:validation:actions_control}
    \includegraphics[width=0.3\textwidth]{figures/actions_metadata}
  }
  \subfigure[Storage traffic overhead]{
    \label{fig:validation:actions_storage}
    \includegraphics[width=0.3\textwidth]{figures/actions_storage}
  }
